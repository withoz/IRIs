...
namespace iris::bridge
{
                                  ...
                                  BuildStats& stats)
    {
        ...
        // 면광원(rect/linear)의 **대비책**은 넓은 원뿔 + 등가 면적의 구면
        // 광원입니다 — 반각 88도이면 실효 입체각이 거의 정확히 pi 라서
        // 램버시안 패널의 축상 광도와 맞습니다. 기본은 발광 지오메트리이고
                                ...
                                BuildStats& stats)
    {
        ...
        // 하기 때문입니다.
        {
            // 호스트 Z-up -> 엔진 월드 Y-up. 씬 전체에 적용하는 것과 같은 회전입니다.
