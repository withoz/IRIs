...
namespace iris::bridge
{
    ...
    public:
        ...
        // **다음에 같은 씬이 와도 받아들입니다.**
        //
        // 내용이 같은 씬은 지문으로 걸러 냅니다 — 안 그러면 BLAS 를 다시
        // 짓고 누적이 초기화돼 화면이 수렴하지 못합니다.
        //
        // 그런데 **씬은 그대로인데 해석이 달라지는** 경우가 있습니다.
        // 저장된 재질 덮어쓰기를 지웠을 때가 그렇습니다(11번 11.6) —
        // 호스트가 보내는 바이트는 한 글자도 안 바뀌지만 이제 그 값이
        // 화면에 나와야 합니다. 그때 이것을 불러 지문을 잊게 합니다.
        void ForgetLastScene();
