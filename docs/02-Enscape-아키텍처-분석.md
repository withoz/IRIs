...
> ### ✅ 결정 (2026-09-07) — **나: RTX 전용, 자료집 경로 B**
>
> 소규모 팀이 1년 내 결과를 낼 수 있는 유일한 경로라는 판단입니다. 위 "가" 항목(자체
> 하이브리드)은 그래픽스 팀의 다년 투자를 요구합니다.
>
> **대가를 인정한 결정입니다** — 시장이 RTX 보유자로 제한되며, 이 문서가 기록한 모순을
> **품질·속도 쪽으로 해소**한 것입니다. 커버리지를 포기한 대신 자료집 추정 6~12개월
> 데모를 취했습니다.
>
> 상세와 귀결: [00-진행상황.md](00-진행상황.md) "확정 사항과 귀결 ③"
